      ...
      builder: (_) => BonfireDialog(
        ...
        description: RichText(
          text: TextSpan(
            ...
            children: <TextSpan>[
              TextSpan(
                text: '${I18n.of(context).textAnonymousDisclaimer1}:\n',
              ),
              TextSpan(
                text: '${I18n.of(context).textAnonymousDisclaimer2}\n',
              ),
              TextSpan(
                text: I18n.of(context).textAnonymousDisclaimer3,
              ),
            ],
          ),
        ),
        ...
        onPressedButton2: () => BlocProvider.of<AuthBloc>(context)
          ..add(
            OnSignInAnonymouslyClicked(),
          ),
        width: 350.0,
        height: 350.0,
      ),
        ...
        child: BlocListener<AuthBloc, AuthState>(
          ...
          listener: (context, state) {
            if (state is SigningInAnonymously) {
              Flushbar(
                message: I18n.of(context).textAnonymousLoggingIn,
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: _alreadyHaveAnAccountLink(),
                    ),
                  ],
                ),
              );
